...
import { Bot, Plane, Wallet, CloudSun, Backpack, ShieldCheck, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-12">
        ...
        {/* Hero */}
        <section className="bg-linear-to-r from-blue-700 to-blue-400 rounded-3xl text-white p-10 lg:p-16 shadow-lg">
        ...
        {/* Footer */}
        <section className="bg-linear-to-r from-blue-700 to-blue-400 rounded-2xl text-white text-center p-12">
